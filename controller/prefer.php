<?php
class controlPrefer extends modelPrefer
{
...
return true;
	...
	public function generate() {
		...
		$dataArray['head'] = array('"id"', '"FirstName"', '"LastName"', '"Email"', '"Institution"', '"ContactOwner"', '"Subscriptions"', '"Doctypes"', '"RecievedEmailFrom"', '"Active"', '"MobileAppAccess"', '"MobileAppUserName', '"MobileAppPassword"');
